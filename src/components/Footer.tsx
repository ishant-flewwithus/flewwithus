...
export default function Footer() {
  return (
    <>
      <div className="mt-1 bg-primary-600 pt-9">
        <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
          <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
            <div className="md:w-[316px]">
              <h1 className="font-extrabold text-white">Flew With Us</h1>
          ...
          <div className="flex flex-col items-center justify-center pb-8 pt-[9px] md:py-8">
            <p className="text-[10px] font-normal text-white md:text-[12px]">
              © Copyright 2024
            </p>
            <p className="text-[10px] font-normal text-white md:text-[12px]">
              All Rights Reserved by Flew With Us PVT. LTD
            </p>
          </div>
        </div>
      </div>
